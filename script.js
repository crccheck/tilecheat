...
(function() {
  var $, bestMatchSort, difference, findNeighbor, getEdgeData, getPixel, getResult, main, n_slices, normalizeResultGrid, resultIsValid, setPixel, shape, slice_w, validEdges, width,
  ...
  main = function() {
    var c, canvas, col, dBits, dTile, dim, edgeData, i, imageData, img, mapping, num, resultGrid, retries, row, sBits, sTile, slices, _i, _len, _results;
    img = $('img');
    width = img.width;
    ...
    while (--retries && !resultIsValid(resultGrid)) {
