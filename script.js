...
(function() {
  var $, bestMatchSort, distance, findNeighbor, getAllEdgeData, getEdgeData, getPixel, getResult, getResult2, main, n_slices, normalizeResultGrid, resultIsValid, retries, setPixel, shape, slice_w, validEdges, vignette_fix, width,
  ...
  main = function() {
    var c, canvas, dBits, dTile, dim, edgeData, height, imageData, img, mapping, resultGrid, sBits, sTile, _results, _retries;
    img = $('img');
