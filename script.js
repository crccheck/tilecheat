...
(function() {
  var $, bestMatchSort, difference, findNeighbor, getEdgeData, getPixel, getResult, main, n_slices, normalizeResultGrid, setPixel, shape, slice_w, validEdges, width,
  ...
  main = function() {
    var c, canvas, col, dBits, dTile, edgeData, i, imageData, img, mapping, num, resultGrid, row, sBits, sTile, slices, _i, _len, _results;
    img = $('img');
    width = img.width;
