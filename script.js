...
(function() {
  var $, bestMatchSort, difference, findNeighbor, getEdgeData, getPixel, main, n_slices, normalizeResultGrid, setPixel, slice_w, validEdges, width,
  ...
  main = function() {
    var attempts, c, canvas, col, dBits, dTile, edgeData, giveUpThreshold, i, imageData, img, mapping, neighbor, newEdgeData, num, placedTiles, positionX, positionY, resultGrid, reverseResultGrid, row, sBits, sTile, slices, solvedCoord, start, threshold, x, _i, _j, _len, _len1, _results;
    img = $('img');
    width = img.width;
